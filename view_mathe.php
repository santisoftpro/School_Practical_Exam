    ...
    <div id="layout">
        ...
        <div id="content">
            ...
            <table>
                ...
                <?php
                 include('config.php');
                 $query=mysqli_query($con,"SELECT * FROM Referees INNER JOIN Adversaries INNER JOIN Matches ON Referees.ref_id=Matches.ref_id and Adversaries.ad_id=Matches.ad_id");
